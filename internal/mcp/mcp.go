...
func tools() []map[string]any {
	return []map[string]any{
		...
		tool("get_output", "Read a generated GoreGraph output by alias, for example graph-full, callgraph, endpoint-flows, spring, endpoints, dependencies, analyzers, workspace, audit."),
