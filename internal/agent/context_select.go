...
func contextExactInventoryScaffoldingTokens() map[string]bool {
	terms := []string{
		...
		"change changed changing create created creating modify modified modifying update updated updating add added adding affected impact impacted impacting",
		...
		"ändere ändern ändernde geändert anlegen angelegt anzulegen anzulegende erstellen erstellt betroffen betroffene betroffenen betroffener betroffenes",
