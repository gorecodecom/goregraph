...
function dashboardProjection(payload) {
  ...
  return {architecture:{generated:serviceMap.generated||graph.generated,nodes,edges,groups},workspace:{generated:serviceMap.generated||graph.generated,root:graph.root||serviceMap.root||'',symbols:payload.symbol_index?.symbols||[],usages:payload.symbol_usages?.usages||[],usageCoverage:payload.symbol_usages?.coverage||[],endpoints:payload.api_catalog?.endpoints||[],traces,health:serviceMap.health||{},workspaceCoverage:serviceMap.workspace_coverage||{},contractSummary:serviceMap.contract_summary||{},capabilities:serviceMap.capabilities||[],diagnosticFamilies:serviceMap.diagnostic_families||[]}};
}
