...
type WorkspaceFeatureFlowRecord struct {
	...
	TestLinks             []TestLinkRecord            `json:"test_links,omitempty"`
	VerificationCommands  []VerificationCommandRecord `json:"verification_commands,omitempty"`
	Confidence            string                      `json:"confidence"`
	Reason                string                      `json:"reason,omitempty"`
	ModelVersion          int                         `json:"model_version,omitempty"`
	Nodes                 []CanonicalFlowNodeRecord   `json:"nodes,omitempty"`
	Edges                 []CanonicalFlowEdgeRecord   `json:"edges,omitempty"`
}
