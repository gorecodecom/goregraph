...
The fresh passing matrix above supersedes it for 1.3.0 qualification and
satisfies the complete-transcript zero-skill rule. Prompt text was not used to
disable skills for either variant.
