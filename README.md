...
- **Code Explorer:** enter from a selected Architecture service to inspect its
  exact symbols, Direct references, Reached through API paths, uncertainty, and
  source evidence without compressing the inventory into an SVG.
