...
The current public release is `v0.5.0`.
...
- JavaScript/TypeScript: functions, classes, imports, exports, package scripts, Express/Fastify-style routes, React Router routes, calls, route flows, and test mappings.
