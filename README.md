...
The current source release target is `v1.2.0`. Public artifacts remain tied to
the latest published tag until that release is explicitly pushed and tagged.
