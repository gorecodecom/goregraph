...
partial or none coverage, inspect only exact project/path entries in
`source_omissions`; do not inspect other files or widen ranges, and report
pathless omissions as uncertainty.
