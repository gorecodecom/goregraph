...
- component-aware frontend route flows that can follow JSX child components to API callers
...
The current public release is `v0.8.5`. The current local development version is `v0.8.6`.
...
Show discovered workspace projects, indexed projects, known backend services, and referenced but missing services without scanning or writing files.
