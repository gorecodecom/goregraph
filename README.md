...
The current development release target is `v0.9.2`.
...
The workspace dashboard at `.goregraph-workspace/workspace-map.html` is a standalone offline UI organized around four questions:
