...
const sourceBackedAssistedInstruction = `Call goregraph context once with a focused query containing the caller's problem statement and requested evidence scope before reading indexed source.
